...
public class OrcidProfile {
  ...
  /**
   * 
   * @param orcidIdentifier The orcid-identifier
   */
  ...
  /**
   * 
   * @param orcidDeprecated The orcid-deprecated
   */
  ...
  /**
   * 
   * @param orcidPreferences The orcid-preferences
   */
  ...
  /**
   * 
   * @param orcidHistory The orcid-history
   */
  ...
  /**
   * 
   * @param orcidActivities The orcid-activities
   */
  ...
  /**
   * 
   * @param orcidInternal The orcid-internal
   */
